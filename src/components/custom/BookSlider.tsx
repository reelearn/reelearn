...
// import VideoCard from "@/components/custom/pages";
import TextPage from "@/components/custom/pages/TextPage";
import PosterPage from "@/components/custom/pages/PosterPage";
...
const BookSlider: FC<Props> = ({ height, book, currentBook }) => {
  ...
  return (
    ...
    >
      {book.pages.map((page, index) => (
        ...
        >
          {page.type === "POSTER" && <PosterPage page={page} />}
          {page.type === "TEXT" && swiperRef.current && (
            <TextPage swiper={swiperRef.current as SwiperRef} page={page} />
          )}
